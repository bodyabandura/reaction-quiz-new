...
function Participating() {
  ...
  const nextQuestion = (option: string) => {
    ...
    setAnswers(prev => ({ ...prev, actively_participate: option }))
    handleNextStep()
  }

  return (
    <div className="flex flex-col items-center">
      <h1 className="font-semibold text-2xl mb-20 text-center">Do team members actively participate and contribute?</h1>
