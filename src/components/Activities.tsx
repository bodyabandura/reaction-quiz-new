...
const options = ["Step challenge", "Stress reduction practice", "Volunteering activity", "Score prediction ",
                "Plank challenge", "Running club", "Water drinking challenge", "7 week nutrition plan"]
...
function Activities() {
  ...
  const handleChosenOptions = (option: string) => {
    ...
    setAnswers(prev => ({ ...prev, activities: newSelected }))
  ...
  return (
    <div className="flex flex-col items-center overflow-y-scroll">
      ...
      <p className="text-2xl font-semibold mb-2">ongoing activities</p>
